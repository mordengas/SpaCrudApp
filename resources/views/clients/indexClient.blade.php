...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link active" >Clients</a>
...
<div class="container mx-auto">
    <h1 class="text-3xl text-center my-10">Clients</h1>
    <button onClick="window.location='{{route('clientsCRUD.create')}}'" class="btn btn-success">Add Client</button>
    <div><br></div>
