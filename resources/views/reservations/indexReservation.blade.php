...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link active">Reservations <span class="sr-only">(current)</span> </a>
...
<div class="container mx-auto">
    <h1 class="text-3xl text-center my-10">Reservations</h1>
    <button onClick="window.location='{{route('reservations.create')}}'" class="btn btn-success">Add Reservation</button>
    <div><br></div>
